...
class WordGenerator:
    '''
    Helper class to generate words or sentences and return them in a list.  
    '''
    def __init__(self):
        pass
    ...
    @staticmethod
    def generate_words(num_words:int):
        '''
        Generate the number of words specified by num_words.
        '''
    ...
    @staticmethod
    def generate_sentences(num_sentences:int):
        '''
        Generate the number of sentences specified by num_sentences.
        '''
        return [wonderwords.RandomSentence().sentence().lower() for _ in range(num_sentences)]

class TypingTest:
    '''
    This is the all-in-one class that displays our text and shows our results.
    We initialize the class, and then run() it to do our WPM.
    It is a simple class, to prove the concept.
    '''
    ...
    def __init__(self) -> None:
        ...
        self.l_prompt_example = tk.Label(text="Test Text", justify=tk.LEFT)
    ...
    def run(self):
        '''
        Run the application and show it onscreen.
        '''
